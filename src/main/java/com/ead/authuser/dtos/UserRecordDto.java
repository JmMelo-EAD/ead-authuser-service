...
public record UserRecordDto(@NotBlank(groups = UserView.RegistrationPost.class,message = "Username is required")
                            ...
                            @Email(groups = UserView.RegistrationPost.class,message = "Email Invalid must be in the expected format")
                            @JsonView(UserView.RegistrationPost.class)
                            String email,

                            @NotBlank(groups = {UserView.RegistrationPost.class, UserView.PasswordPut.class},message = "Password is required")
                            @Size(groups = {UserView.RegistrationPost.class, UserView.PasswordPut.class},min = 8, max = 20, message = "Password must be between 6 and 20 characters")
                            ...
                            @Size(groups = UserView.PasswordPut.class,min = 8, max = 20, message = "Old Password must be between 8 and 20 characters")
